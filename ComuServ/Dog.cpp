...
#undef MSG_HEAD
#define MSG_HEAD ("ComuServ-DOG")

#if SMALL_VER == 0
const DWORD DOG_RSTVAL = 0XFFFFFFFF & ~DOG_QIAN & ~DOG_COMU & ~DOG_SOCK & ~DOG_IO & ~DOG_UPGD & ~DOG_DVR & ~DOG_DVR_T1 & ~DOG_DVR_T2 & ~DOG_DVR_T3;
#endif

#if SMALL_VER == 1
const DWORD DOG_RSTVAL = 0XFFFFFFFF & ~DOG_QIAN & ~DOG_COMU & ~DOG_SOCK & ~DOG_IO & ~DOG_UPGD & ~DOG_DVR_T1 & ~DOG_DVR_T2 & ~DOG_DVR_T3;
#endif
