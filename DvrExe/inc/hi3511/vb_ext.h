...
*****************************************************************************/
extern HI_S32 VB_CreatePool(HI_U32 *pu32PoolId,HI_U32 u32BlkNum, HI_U32 u32BlkSize,...);

/*****************************************************************************
 Prototype    : VbDestroyPool
 Description  : destroy a specified pool
 Input        : u32PoolId  : the ID of pool to be destroied.
 Output       : 
 Return Value : HI_S32     : 0 -- success; !0 -- failure.
*****************************************************************************/ 

HI_S32 VB_CreatePoolExt(HI_U32 *pu32PoolId,HI_U32 u32BlkCnt, HI_U32 u32BlkSize,HI_CHAR *pszName);
...
/*****************************************************************************
 ...
 Return Value : HI_S32 
                ...
                failure : Not 0
*****************************************************************************/
extern HI_S32 VB_GetPoolId(HI_U32 u32BlkSize,HI_U32 *u32PoolId);
...
/*****************************************************************************
 ...
 Return Value : VB_BLKHANDLE
                ...
                failure : VB_INVALID_HANDLE     
*****************************************************************************/
extern VB_BLKHANDLE VB_GetBlkBySize(HI_U32 u32BlkSize,HI_U32 u32Uid);
