...
// QianExe使用
#define USE_LIAONING_SANQI	1	// 1, 使用辽宁移动三期协议，0, 不使用
...
#define USE_AUTORPTSTATION	0	// 1,启用公交自动报站；0，不启用
...
#define VIDEO_BLACK_TYPE	1	// 1, 视频黑匣子上传使用旧协议，2, 使用新协议
...
#if CHK_VER == 0
	#define SOFT_VER		"c190e-110v8t001-402"
#else
	#define SOFT_VER		"t008-110v8t001-001"
#endif
	...
	#define SOFT_VER		"c190e-110v8t001-bkp"
...
#define QTCPIP		"59.61.82.170"		// 千里眼TCP IP地址
...
#endif
#if USE_LIAONING_SANQI == 0
#define QUDPIP		"59.61.82.170"		// 千里眼UDP IP地址
...
#endif
#if USE_LIAONING_SANQI == 0
#define DTCPIP		"125.77.254.122"	// DVR视频的TCP IP地址
#define DTCPPORT	6500				// DVR视频的TCP端口
#endif
...
struct tag2QReportCfg
{
	...
	tag2QReportPar	m_objBelowSpdRptPar;
	tag2QReportPar	m_objCrossSpdRptPar;
...
//	tag2QReportPar  m_objStopTimePrtPar;
	...
	void Init()
	{
		...
		m_objBelowSpdRptPar.Init("r001", false, 0x00, 1, 20);
		m_objCrossSpdRptPar.Init("r001", false, 0x00, 1, 20);
