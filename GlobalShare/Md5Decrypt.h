#ifndef _MD5DECRYPT_H_
#define _MD5DECRYPT_H_
...
public:
	...
	/// 接口函数：加密数据
	int DesEncrypt( char *Out, char *In, long datalen, const char *Key, int keylen);
	/// 接口函数：解密数据
	int DesDecrypt( char *Out, char *In, long datalen, const char *Key, int keylen);
