...
#define AUTO_PICKUP		1		// 1,表示来电自动接听; 0, 来电不自动接听
...
#define VIDEO_BLACK_TYPE	1	// 1, 视频黑匣子上传使用旧协议，2, 使用新协议
...
#if CHK_VER == 0
	#define SOFT_VER		"c090c-110v8t001-002"
#else
	...
	#define SOFT_VER		"c090c-110v8t001-bkp"
...
#define QTCPIP		"218.204.62.6"		// 千里眼TCP IP地址
...
#endif
#if USE_LIAONING_SANQI == 0
#define QUDPIP		"218.204.62.6"		// 千里眼UDP IP地址
...
#endif
#if USE_LIAONING_SANQI == 0
#define DTCPIP		"218.204.62.6"		// DVR视频的TCP IP地址
